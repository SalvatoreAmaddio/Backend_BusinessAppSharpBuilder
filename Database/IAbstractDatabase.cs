...
namespace Backend.Database
{
    ...
    public interface IAbstractDatabase : IDisposable
    {
        ...
        /// Set this property to take advantage of auto-generated queries built by <see cref="CRUDQueryBuilder"/>.
        /// </summary>
        ...
        ///<description>if null, the <see cref="Model"/> property sets this parameter to the SQL Statement generated by <see cref="CRUDQueryBuilder"/>. Otherwise, you can provide your own Select Statement.</description>
        ///</item>
        /// <item>
        ...
        /// <item>
        ///<term><paramref name="sql"/></term>
        ///<description>If null, the <see cref="Model"/> property sets this parameter to the SQL Statement generated by <see cref="CRUDQueryBuilder"/>. Otherwise, you can provide your own CRUD Statement.</description>
        ///</item>
        /// <item>
        ///<term><paramref name="parameters"/></term>
        ///<description>If null, the <see cref="Model"/> property sets this parameter to the <see cref="ISQLModel.SetParameters(List{IParameterObject}?)"/>. defined in your class. Otherways you can provide your own <c>List&lt;IParameterObject&gt;"</c> </description>
        ...
        /// <item>
        ///<term><paramref name="sql"/></term>
        ///<description>If null but the <see cref="Model"/> property is set, it sets this parameter to the SQL Count Statement generated by <see cref="CRUDQueryBuilder"/>. Otherwise, you can provide your own CRUD Statement.</description>
        ///</item>
        /// <item>
        ///<term><paramref name="parameters"/></term>
        ///<description>null if your statement does not rely on parameters. This method won't use the <see cref="ISQLModel.SetParameters(List{IParameterObject}?)"/></description>
